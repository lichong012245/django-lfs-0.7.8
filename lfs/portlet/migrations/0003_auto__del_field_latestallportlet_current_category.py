...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LatestAllPortlet.current_category'
        db.delete_column('portlet_latestallportlet', 'current_category')


    def backwards(self, orm):
        # Adding field 'LatestAllPortlet.current_category'
        db.add_column('portlet_latestallportlet', 'current_category',
